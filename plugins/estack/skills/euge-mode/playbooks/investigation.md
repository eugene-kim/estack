...
No PR, no follow-up loop, no `architect` unless the investigation is a precursor to changing code. If it is, hand back to the user and re-route to Bug fix or Feature.
