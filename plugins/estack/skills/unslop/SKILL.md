...
28. **Self-narrating artifacts.** Delete sentences that announce what the document plainly does. Let headings, links, tables, and structure do their jobs. Keep orientation only when it adds scope, audience, prerequisites, or consequences the reader cannot infer.
