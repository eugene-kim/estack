...
this run's transcript from the active workspace or transcript location provided
by the environment. Do not search unrelated project transcript locations; that
may read unrelated private chats. Walk the log against what actually happened:
...
Before handing back, you must spawn a subagent for a fresh-eyes review: on a different model family from the one that did the work where your platform offers one, otherwise a different model tier in a fresh context. Self-review is not a substitute; the point is fresh eyes you cannot bring yourself. The subagent reads the audit trail and the run's transcript, then flags what the user should pay attention to. Not a redo of the work, a scan for what's suboptimal or risky.
