...
1. Follow your platform's skill-authoring flow for writing SKILL.md files (for example, a `create-skill`-style draft/test/iterate loop if your platform has one).
